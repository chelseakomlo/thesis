...
A key-recover attack is possible is because the adversary can force honest parties to re-use their nonces,
...
which in tern leads to the challenge $c$ changing.
