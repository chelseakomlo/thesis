  ...
  \centering
        \begin{tikzpicture}
                \begin{groupplot}[group style = {group size = 5 by 1,
                  horizontal sep = 35pt}, width = 10cm, height = 7.0cm]
                        \nextgroupplot[ title = {},
                        xmax=29.9,
                        ymin=0.2,
...
%\include{arctic/figures/cn.tex}
        \begin{tikzpicture}
                ...
                \end{groupplot}
        \end{tikzpicture}
  \caption[Scaling experiemnt.]{Scaling experiment, showing the wall clock time of $(n,|\coalition|,t) = (25, 25, 11)$ shown in Figure~\ref{fig:exp-nt} relative to CPU cores.
  }
