...
%\include{arctic/figures/cn.tex}
        \begin{tikzpicture}
                ...
                \end{groupplot}
        \end{tikzpicture}
  \caption[Scaling experiment.]{Scaling experiment, showing the wall clock time of $(n,|\coalition|,t) = (25, 25, 11)$ shown in Figure~\ref{fig:exp-nt} relative to CPU cores.
  }
