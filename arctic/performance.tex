...
%                \end{groupplot}
%        \end{tikzpicture}
%\caption{Single-core wall clock time for various parameter combinations
%for \glitter.  The times shown are the sum of the computation times for
...
%
%\begin{figure}[t]
%%\include{arctic/figures/cn.tex}
%\caption{Scaling experiment, showing the wall clock time for the largest
%configuration $(n,|\coalition|,t) = (25, 25, 11)$ shown in Figure~\ref{fig:exp-nt} as we increase the number
%of CPU cores.}
