...
We now define additional preliminaries used specifically in this chapter.
...
\end{pcvstack}
    ...
    defined with respect to an algorithm $\cdv$ and instance $X$.
...
We review the general forking lemma by Bellare and Neven~\cite{BellareN06}, which itself is a formalization of the forking lemma  introduced by Pointcheval and Stern~\cite{PointchevalS96}.
