...
\begin{theorem}\label{thm:unforgeability}
	\glitter is unforgeable in the ROM against a PPT adversary $\adv$ playing the static unforgeability game as shown in Figure~\ref{fig:euf-cma-threshold} against \glitter,
