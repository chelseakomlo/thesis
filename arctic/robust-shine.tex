\section{Details on Extending \DVRFOne and \glitter to be Robust}
\label{app:robust-shine}
...
remaining honest player was the outlier.  Therefore, as we will see in
the next section, \glitter will have to just abort in the case that
