...
\caption{Robustness experiment for a DKG.
}
...
First, we define common oracles that are used within the respective security
...
\begin{figure}[t]
  ...
  \end{pchstack}
  \end{framed}
\caption{Common oracles used within security experiments for a distributed key generation scheme.
}
\label{fg:keygen-o}
\end{figure}
