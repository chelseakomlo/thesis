...
UC-definition of idealized discrete-logarithm key generation with additive bias,
...
\hline
	\end{tabular}
  \smallskip
  \caption[Comparison of DKG Constructions]{Comparison between \RG and related, non-publicly-verifiable, synchronous constructions.
  }
...
\RG (\underline{S}ynchronous, dis\underline{T}ributed,
\underline{O}ptimized gene\underline{R}a\-tion of key \underline{M}aterial).
