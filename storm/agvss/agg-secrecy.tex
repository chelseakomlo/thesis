...
\begin{figure}[p]
  ...
  \begin{pcvstack}
    \procedure[]{$\getshare() \text{\algcom Performs secret sharing}$}{
      ...
      \pcind \pcif b=0 \\
      \pcind \pcind \{(j,\share_{j})\}_{j =1}^n, \vsscommit \rgets \avss.\issueshares(\lambda, s, n, t) \\
      ...
      \{(j,\share_{\simtotal j})\}_{j =1}^n, \vsscommit_\simtotal \rgets \avss.\issueshares(\lambda, s_\simtotal, n, t) \\
