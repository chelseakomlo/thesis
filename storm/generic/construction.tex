...
\procedure[]{$\dkgkeygen_0[\Hash](\lambda, n, t, i)$} {
    \pp \gets \enike.\Setup(1^\lambda);\ \pp' \gets \avss.\Setup(1^\lambda) \\
...
\begin{assumption} \label{ass:avss-enike}
  ...
  \begin{align} \label{eq:avss-enike-rel}
    \begin{split}
      ...
      (\{ (i, \share_i) \}_{i \in \set{n}}), \vsscommit) \rgets \avss[\Hash].\issueshares(\sk, n, t) \text{ and } \\
...
then all honest participants will receive a sufficient number of honest shares to recovery successfully,
