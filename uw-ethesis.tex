...
\pgfplotsset{table/search path={arctic/figures}}
...
\theoremstyle{definition} % Use normal font style for the remark
\newtheorem{case}{Case}
...
\input{frost/frost.tex}
\input{storm/storm.tex}
\input{arctic/arctic.tex}
\input{conclusion}
...
\bibliography{cryptobib/abbrev3,uw-ethesis}
