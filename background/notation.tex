...
Let $\GroupGen$ be a polynomial-time algorithm that takes as input a security parameter
$1^\usecp$ and outputs a group description $(\Gr, q, g)$ consisting of a group $\Gr$ of order $q$, where $p$ is a $\secp$-bit prime, and a generator $g$ of $\Gr$.
