...
\subsection{A Modified Forking Lemma}
...
as it simply bounds the probability that two values sampled uniformly at random from a set (with replacement) might collide.
As such,
it bounds the probability that the same value might be sampled twice,
when $2\forkhashes $ total sampling events are performed.
