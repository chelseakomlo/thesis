...
as it simply counts the probability that two values sampled uniformly at random from a set (with replacement) might collide.
As such,
it counts the probability that the same value might be sampled twice,
