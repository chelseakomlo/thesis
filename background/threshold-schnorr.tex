...
Note that our definition of threshold signatures simply assumes that participants exchange messages $ \{\msg_{ 1, j}$ where $i$ represents participant $i$  and $j$ represents the $j$\supth signing round.
