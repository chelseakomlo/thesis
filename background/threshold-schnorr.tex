...
Note that notions of strong static unforgeability also existy for threshold signatures~\cite{BellareCKMTZ22},
which also assert that the signature is unique.
