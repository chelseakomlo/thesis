...
participants exchange messages $ \{\gmsg_{ 1, j}$ where $i$ represents participant $i$  and $j$ represents the $j$\supth signing round.
...
\begin{remark}[On Protocol Message Types]
  ...
  and simplify defines protocol messages $\gmsg$.
  The concrete construction of the threshold signature scheme will provide the necessary structures to realize any necessary assumptions for protocol messages delivery.
\end{remark}
