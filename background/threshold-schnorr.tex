...
$\UnforgExp_{\A,\threshsig}(\secp, n, \tcor, \tcornew)$, as defined in Figure~\ref{fig:euf-cma-threshold}, be as follows:
%
\[
  \advant{$\uf$}{\threshsig, \adv}(\secp, n, \tcor, \tcornew) =
  \bigabs{\Pr[\UnforgExp_{\threshsig,\adv}(\secp, n, \tcor, \tcornew) = 1]}
\]
...
We leave proving the adaptive security of both FROST in Chapter~\ref{chp:frost} and Arctic in Chapter~\ref{chp:arctic} to future work.
