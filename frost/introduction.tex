...
operations~\cite{GennaroJKR03, DamgardJNPO22}, and refer
to the threshold
...
\begin{itemize}
  ...
  \item {\sloppy We present FROST, a Flexible Round-Optimized Schnorr Threshold signature
    scheme.
    ...
    known forgery attacks without limiting the concurrency of signing operations.\par}
