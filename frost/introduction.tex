...
\begin{itemize}
  ...
  \item We present a proof of security and correctness for
    an interactive two-round variant of FROST, building upon proofs of security for prior
    related threshold schemes.
    We then discuss how this proof extends to plain FROST in the single-rounnd
    setting.
Note that subsequent works have given a direct proof for FROST~\cite{BellareCKMTZ22}.
\end{itemize}
